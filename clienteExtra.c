...
int matrizLocal[TAMANO_FILA][TAMANO_COLUMNA];
int matrizRival[TAMANO_FILA][TAMANO_COLUMNA];
char jugador1[20];
char jugador2[20];
            ...
            if (strcmp(buf, "S OBSERVADOR\n") == 0){
                ...
                while ((strcmp(strtok(fragmentacion[1], "\n"), "GANA") != 0) && (fgets(buf, LBUFFER, fd_sock)!= NULL)){
                    ...
                    if (strcmp(strtok(fragmentacion[2], "\n"), "TOCADO") == 0){
                        ...
                        printf("\n");
                        if (strcmp(jugador1, strtok(fragmentacion[3], "\n")) == 0){
                            printf("A continuacion le mostramos las posiciones a las que ha disparado %s \n\n", jugador1);
                            matrizRival[atoi(strtok(fragmentacion[5], "\n"))][atoi(strtok(fragmentacion[4], "\n"))] = 1;
                            for (int i = 0;i < TAMANO_FILA; i++){
                                for (int j = 0;j < TAMANO_COLUMNA; j++){
                                    printf("%d ", matrizRival[i][j]);
                                }
                                printf("\n");
                            }
                            printf("\n");
                        }
                        else if (strcmp(jugador2, strtok(fragmentacion[3], "\n")) == 0){
                            printf("A continuacion le mostramos las posiciones a las que ha disparado %s \n\n", jugador2);
                            matrizLocal[atoi(strtok(fragmentacion[5], "\n"))][atoi(strtok(fragmentacion[4], "\n"))] = 1;
                            for (int i = 0;i < TAMANO_FILA; i++){
                                for (int j = 0;j < TAMANO_COLUMNA; j++){
                                    printf("%d ", matrizLocal[i][j]);
                                }
                                printf("\n");
                            }
                            printf("\n");
                        ...
                        strcpy(jugador1, strtok(fragmentacion[2], "\n"));
                        strcpy(jugador2, strtok(fragmentacion[3], "\n"));
                    }
                }
                ...
                if (strcmp("S ESPERA\n", buf) == 0){
                    ...
                    while ((fgets(buf, LBUFFER, fd_sock)!= NULL) && (strcmp(buf, "S PREMIO\n") != 0) && (strcmp(buf, "S SIGUE JUGANDO\n")) != 0){
                        ...
                        if (strcmp(buf, "S TUTURNO\n") == 0){
                            ...
                            matrizRival[fila][columna] = 1;
                            printf("\n");
                            printf("A continuacion le mostramos las posiciones a las que has disparado \n\n");
                            for (int i = 0;i < TAMANO_FILA; i++){
                                for (int j = 0;j < TAMANO_COLUMNA; j++){
                                    printf("%d ", matrizRival[i][j]);
                                }
                            ...
                            printf("\n");
                            printf("Ha fallado. Espere su turno\n\n");
                        }
                        else if (strcmp(strtok(fragmentacion[2], "\n"), "TOCADO") == 0){
                            printf("El rival %s ha TOCADO una flota en [%s] [%s] . \n", strtok(fragmentacion[3], "\n"), strtok(fragmentacion[4], "\n"), strtok(fragmentacion[5], "\n"));
                            printf("\n");
                            printf("A continuacion le mostramos las posiciones a las que ha disparado el rival\n\n");
                            matrizLocal[atoi(strtok(fragmentacion[5], "\n"))][atoi(strtok(fragmentacion[4], "\n"))] = 1;
                            for (int i = 0;i < TAMANO_FILA; i++){
                                for (int j = 0;j < TAMANO_COLUMNA; j++){
                                    printf("%d ", matrizLocal[i][j]);
